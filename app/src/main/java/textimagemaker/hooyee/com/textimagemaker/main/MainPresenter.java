...
public class MainPresenter implements MainContract.Presenter {
    ...
    private void preview() {
        ...
        Drawable drawable = Util.createDrawable(mView.getTextContent(),20, Util.getScreenWidth(mContext),
                Util.getScreenHeight(mContext), FlagModel.getInt(mContext, Constants.TEXT_COLOR, Color.WHITE), alignment);
