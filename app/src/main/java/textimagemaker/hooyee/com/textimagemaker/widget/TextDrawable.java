...
//    private int mWidth;
//    private int mHeight;StringUtil
    private TextPaint mPaint;
    private Layout.Alignment mAlign;

    public TextDrawable(String content,int textSize, int width, int height, int color) {
        this(content,textSize, width, height, color,Layout.Alignment.ALIGN_CENTER);
    }

    public TextDrawable(String content,int textSize ,int width, int height, int color, Layout.Alignment align) {
